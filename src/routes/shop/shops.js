...
import { BellRing, Delete, Trash2, X } from 'lucide-react'
...
const Shops = () => {
  ...
  // Delete
  const [visibleDeleteShop, setVisibleDeleteShop] = useState(false)
  const [reqShop2Delete, setReqShop2Delete] = useState({})
  ...
  const renderPagination = () => {
    ...
    for (let i = 1; i <= totalPages; i++) {
      pageNumbers.push(
        <CPaginationItem key={i} active={i === page} onClick={() => handlePageChange(i)}>
          {i}
        </CPaginationItem>,
      )
    }
  ...
  const processDeleteShop = (shop) => {
    setVisibleDeleteShop(true)
    setReqShop2Delete(shop)
  }
  ...
  return (
    <>
      ...
      <DeleteShop
        visible={visibleDeleteShop}
        setVisible={setVisibleDeleteShop}
        shop={reqShop2Delete}
      />
      <DefaultShopModal
        visible={visibleDefault}
        setVisible={setVisibleDefault}
        shop={requestShop}
        user={requestUser}
      />
      <ToggleShopModal
      ...
      <AssignToModal
        visible={visibleAssignTo}
        setVisible={setVisibleAssignTo}
        shop={requestShop}
        user={requestUser}
      />
        ...
        <CCol>
          <CDropdown>
            ...
            <CDropdownMenu>
              ...
              <CDropdownItem
                onClick={() => handleSortChange('updated_newest')}
                className={sort === 'updated_newest' ? 'active' : ''}
              >
                Cập nhật mới nhất
              </CDropdownItem>
              <CDropdownItem
                onClick={() => handleSortChange('updated_oldest')}
                className={sort === 'updated_oldest' ? 'active' : ''}
              >
                Cập nhật cũ nhất
              </CDropdownItem>
            </CDropdownMenu>
                  ...
                  {shops.map((shop, index) => (
                    <CTableRow v-for="item in tableItems" key={index}>
                      ...
                      <CTableDataCell className="text-center">
                        ...
                        {defaultShop && defaultShop.id == shop.id && (
                          <CFormLabel className="ms-2 font-bold">SHOP MẶC ĐỊNH</CFormLabel>
                        )}
                      </CTableDataCell>
                      <CTableDataCell className="text-center d-none d-md-table-cell">
                        ...
                        {shop.status === 'authorized' || shop.status === 'CONNECTED' ? (
                          <CButton
                            ...
                            size="sm"
                            className="me-2 mb-2"
                            onClick={() => processToggleShop(shop)}
                          >
                            <CIcon icon={cilToggleOff} className="me-2 danger" />
                            Tắt Shop
                          </CButton>
                        ) : (
                          <CButton
                            ...
                            onClick={() => processToggleShop(shop)}
                          >
                            <CIcon icon={cilToggleOn} className="me-2 success" />
                            Kích hoạt Shop
                          </CButton>
                        )}
                        <CButton
                          ...
                          size="sm"
                          className="me-2 mb-2"
                          onClick={() => processSyncOrders(shop)}
                        >
                        ...
                        <CButton
                          ...
                          size="sm"
                          className="me-2 mb-2"
                          onClick={() => processSyncProducts(shop)}
                        >
                          <CIcon icon={cilSync} className="me-2" />
                          Sync sản phẩm
                        </CButton>
                        ...
                        {defaultShop && defaultShop.id != shop.id && (
                          <CButton
                            color="danger"
                            size="sm"
                            className="me-2 mb-2 color-white"
                            onClick={() => processDefaultShop(shop)}
                          >
                        ...
                        <CButton
                          ...
                          onClick={() => processDeleteShop(shop)}
                        >
