  ...
  return (
    <>
      ...
      <DeleteUser
        ...
        user={selectUser}
        members={usersToModify}
        onChange={setModifyStatus}
        isDeleteMultiple={isDeleteMultiple}
      />
      <AddUsersToGroup
        visible={visibleAddMembersToGroup}
        setVisible={setVisibleAddMembersToGroup}
        members={usersToModify}
        onChange={setModifyStatus}
      />
      <CRow>
        ...
        <CCol className={showAction ? 'd-block' : 'd-none'}>
          <CInputGroup className="mb-3">
            ...
            <CButton
              ...
              variant="outline"
              id="button-addon2"
              onClick={() => handleMultipleAction(document.getElementById('multipleAction').value)}
            >
              Apply
            </CButton>
          </CInputGroup>
              ...
              <CTable align="middle" className="mb-0 border" hover responsive>
                <CTableHead className="text-nowrap">
                  <CTableRow>
                    ...
                    <CTableHeaderCell className="bg-body-tertiary">Account</CTableHeaderCell>
                    <CTableHeaderCell className="bg-body-tertiary">Email</CTableHeaderCell>
                    <CTableHeaderCell className="bg-body-tertiary">Ngày tạo</CTableHeaderCell>
                    ...
                    <CTableRow v-for="item in tableItems" key={index}>
                      ...
                      <CTableDataCell>
                        {user.isActive ? (
                          ...
                          <div className="text-decoration-line-through">{user.username}</div>
                        )}
                      </CTableDataCell>
                      <CTableDataCell>
                        {user.isActive ? (
                          ...
                          <div className="text-decoration-line-through">{user.email}</div>
                        )}
                      </CTableDataCell>
                      <CTableDataCell>
                      ...
                      <CTableDataCell className="">
                        {user.Team && user.isActive && user.Team.name
                          ? user.Team.name
                          : 'Chưa có nhóm'}
                      </CTableDataCell>
