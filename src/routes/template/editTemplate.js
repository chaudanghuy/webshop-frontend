                ...
                <div className="row g-3">
                  ...
                  <CCol md={6}>
                    ...
                    <CFormSelect
                      ...
                      name="type"
                      aria-label="Loại"
                      defaultValue={template && template.type ? template.type : 'Dropshipping'}
                      readOnly
                      disabled
                    >
                ...
                <div className="row g-3">
                  <CCol xs={12}>
                    <CFormInput
                      ...
                      label="Tên"
                      placeholder=""
                      value={template && template.productTemplate}
                      readOnly
                      disabled
                    />
                  </CCol>
                    ...
                    existingCompliances.some((item) => item.id != compliance.id) ? (
                      <div className="col-4" key={compliance.id}>
                        ...
                        <CFormInput
                          ...
                          name={compliance.id}
                          value={
                            existingCompliances.find((item) => item.id == compliance.id)?.label
                          }
                          readOnly
                          disabled
                        />
                      ...
                      <CCol md={4} key={index}>
                        ...
                        <CFormSelect
                          ...
                          onChange={(e) =>
                            handleFormComplianceChange(compliance.id, e.target.value)
                          }
                        >
                  ...
                  {skus &&
                    skus.map((row) => (
                      <CRow key={row.idSku} className="mb-3 border p-3 rounded">
                        <CRow>
                          <CCol col="auto">
                            <CImage src={row.image} width="150px" height="150px" shape="square" />
                          </CCol>
                          <CCol col="auto">
                            <CFormInput
                              className="mt-5"
