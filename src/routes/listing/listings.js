              ...
              <CTable align="middle" className="mb-0 border" hover responsive>
                <CTableHead className="text-nowrap">
                  <CTableRow>
                    ...
                    <CTableHeaderCell className="bg-body-tertiary">Cào lúc</CTableHeaderCell>
                    <CTableHeaderCell className="bg-body-tertiary">Cập nhật lúc</CTableHeaderCell>
                    <CTableHeaderCell className="bg-body-tertiary text-center">
                      Cửa hàng đăng lên
                    </CTableHeaderCell>
                    <CTableHeaderCell className="bg-body-tertiary text-center">
                ...
                <CTableBody>
                  {listings.map((item, index) => (
                    <CTableRow
                      ...
                      key={index}
                      color={
                        filter && filter.asin && filter.asin.includes(item.sku) ? 'danger' : ''
                      }
                    >
                      <CTableDataCell>
                        <CFormCheck
                      ...
                      <CTableDataCell>
                        ...
                        <div className="small text-medium-emphasis d-block text-start">
                          #{item.sku}
                        </div>
                      </CTableDataCell>
                      ...
                      <CTableDataCell className="text-center d-none d-md-table-cell">
                        <CButton
                          className="me-2 mb-2 d-block"
                          color="warning"
                          size="sm"
                          onClick={() => callEdit(item.id)}
                        >
                        ...
                        <CButton
                          ...
                          color="danger"
                          size="sm"
                          onClick={() => callDelete(item.id, item.name)}
                        >
