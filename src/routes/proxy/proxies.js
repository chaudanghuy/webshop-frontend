...
import EditPoxy from './editProxy'
...
const Proxies = () => {
  ...
  const [proxy2Edit, setProxy2Edit] = useState({})
  ...
  return (
    <>
      <EditPoxy visible={visibleEdit} setVisible={setVisibleEdit} proxy={proxy2Edit} />
              ...
              <CTable align="middle" className="mb-0 border" hover responsive>
                <CTableHead className="text-nowrap">
                  <CTableRow>
                    ...
                    <CTableHeaderCell className="bg-body-tertiary">Shop</CTableHeaderCell>
                    <CTableHeaderCell className="bg-body-tertiary text-center">
                      Active
                    </CTableHeaderCell>
                    <CTableHeaderCell className="bg-body-tertiary text-center">
                ...
                <CTableBody>
                  {proxies.map((item, index) => (
                    <CTableRow v-for="item in tableItems" key={index}>
                      ...
                      <CTableDataCell>
                        <div>{item.shop ? item.shop.name : 'N/A'}</div>
                      </CTableDataCell>
                      <CTableDataCell className="text-center">
                      ...
                      <CTableDataCell className="text-center d-none d-md-table-cell">
                        ...
                        {item.isActive == 1 ? (
                          <CButton
                            ...
                            color="warning"
                            size="sm"
                            onClick={() => handleProxyStatus(item.id, 0)}
                          >
                          ...
                          <CButton
                            ...
                            color="success"
                            size="sm"
                            onClick={() => handleProxyStatus(item.id, 1)}
                          >
